...
# clean
rm -rf /c/OM114/OpenModelica_releases/${OM_ENCRYPT}/v*
rm -rf build
...
cd /c/OM114/${OM_ENCRYPT}OM${PLATFORM}/OMSetup
git checkout maintenance/v1.14
git pull
...
rm -rf OMPython
git clone https://github.com/OpenModelica/OMPython -q -b master /c/OM114/${OM_ENCRYPT}OM${PLATFORM}/OMPython
# build OMPython
...
git clone https://github.com/PySimulator/PySimulator -q -b master /c/OM114/${OM_ENCRYPT}OM${PLATFORM}/build/share/omc/scripts/PythonInterface/PySimulator

# get Figaro
cd /c/OM114/${OM_ENCRYPT}OM${PLATFORM}/build/share
